...
-- y	=>  Location: PIN_AD12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
ARCHITECTURE structure OF mainVHDL IS
...
-- Equation(s):
-- \y~0_combout\ = (\b~combout\ & (\c~combout\)) # (!\b~combout\ & ((\a~combout\)))
